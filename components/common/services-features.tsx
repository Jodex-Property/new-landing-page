...
const ServicesFeatures = () => {
  return (
    <section
      className="min-h-screen flex items-center justify-center mt-28"
      id="services-features"
    >
      <div className="w-full max-w-screen-lg mx-auto py-12 px-6">
        <h2 className="font-heading text-3xl leading-10 sm:text-4xl md:text-[40px] md:leading-[3.25rem] text-[#020749] font-bold tracking-tight">
        ...
        <div className="mt-8 grid sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-muted rounded-xl pt-6 md:pt-8 pb-6 px-6 col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <span className="text-2xl font-semibold tracking-tight">
              For Landlords & Property Manager
            </span>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <div className="flex items-start gap-3">
                  ...
                  <p className="-mt-0.5">Guaranteed & Early Rent</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <Wallet className="shrink-0" />
                  <p className="-mt-0.5">Financial Security</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <Users className="shrink-0" />
                  <p className="-mt-0.5">Access to Trusted Artisans</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <HousePlus className="shrink-0" />
                  <p className="-mt-0.5">Hassle-Free Property Management</p>
                </div>
              </li>
            </ul>

            <Link
              href="https://landlord.jodex.net"
              target="_blank"
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <div className="flex items-start gap-3">
                  ...
                  <p className="-mt-0.5">Flexible Rent-Saving Plans</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <BadgeCheck className="shrink-0" />
                  <p className="-mt-0.5">Access to Verified Listings</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <NotebookText className="shrink-0" />
                  <p className="-mt-0.5">Personality Test for Shared Living</p>
                </div>
              </li>
            </ul>

            <Link
              href="https://tenant.jodex.net"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button className="mt-6 w-full bg-[#020749] hover:bg-[#efde3c] text-white hover:text-gray-900 cursor-pointer">
          ...
          <div className="bg-muted rounded-xl pt-6 md:pt-8 pb-6 px-6 col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <div className="flex items-start gap-3">
                  <BadgeCheck className="shrink-0" />
                  <p className="-mt-0.5">Access to Verified Listings & Leads</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <Handshake className="shrink-0" />
                  <p className="-mt-0.5">Fast & Secure Deal Closures</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <HandCoins className="shrink-0" />
                  <p className="-mt-0.5">Fair Commission Structure</p>
                </div>
              </li>
              <li>
                <div className="flex items-start gap-3">
                  <BanknoteArrowUp className="shrink-0" />
                  <p className="-mt-0.5">Expand Network & Grow Income</p>
                </div>
              </li>
            </ul>

            <Link
              href="https://agent.jodex.net"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button className="mt-6 w-full bg-[#020749] hover:bg-[#efde3c] text-white hover:text-gray-900 cursor-pointer">
