  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative grow">
        <div className="sm:absolute sm:-translate-y-1/2 top-0 inset-x-0 mx-auto w-[90%] max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl flex flex-col lg:flex-row lg:items-center justify-between gap-8 sm:gap-10 rounded-lg bg-background sm:shadow-lg dark:shadow-foreground/10 py-10 sm:py-14 px-4 sm:px-10">
